...
│   │   ├── WelcomeCard.js      # User welcome section
│   │   ├── StatsGrid.js        # Statistics cards
│   │   ├── ChartsSection.js    # Charts container
│   │   ├── RealtimeMonitor.js  # Real-time gauges
│   │   ├── ActivityFeed.js     # Recent activities
│   │   └── QuickActions.js     # Quick action buttons
│   │
│   ├── charts/
│   │   ├── ProductionChart.js  # Production chart
│   │   ├── QualityChart.js     # Quality pie chart
│   │   ├── EfficiencyChart.js  # Efficiency line chart
│   │   ├── ProcessStatus.js    # Process status chart
...
│       ├── ChartCard.js        # Chart container card
│       ├── UserDropdown.js     # User dropdown menu
